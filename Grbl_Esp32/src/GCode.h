...
enum class NonModal : uint16_t {
    ...
    KinematicsCoreXY = 800,       // G800 - custom: set CoreXY kinematics
    KinematicsCartesian = 801,    // G801 - custom: set Cartesian kinematics
    KinematicsSwapXY = 802,       // G802 - custom: set Swap X<->Y
};
