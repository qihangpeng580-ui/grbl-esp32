...
IntSetting* kinematics_mode_setting;
...
void make_settings() {
    ...
    // Kinematics mode persistent setting: $K0 -> 0=Cartesian,1=CoreXY,2=SwapXY
    kinematics_mode_setting = new IntSetting(GRBL, WG, "K0", "Kinematics/Mode", DEFAULT_KINEMATICS_COREXY, 0, 2);
}
