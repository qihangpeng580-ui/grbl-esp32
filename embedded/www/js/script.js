...
function bt_icon(){
    var content = "<svg width='24' height='24' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>";
    content += "<path d='M2 17.25V22h4.75L17.81 10.94l-4.75-4.75L2 17.25z' fill='#000'/>";
    content += "<path d='M20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34a.9959.9959 0 0 0-1.41 0l-1.83 1.83 4.75 4.75 1.83-1.83z' fill='#000'/>";
    content += "</svg>";
    return content;
}
